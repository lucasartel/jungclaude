...
class BakhtinianPolyphonyEngine:
    ...
    def build_polyphonic_prompt_block(
        ...
        *,
        ...
        stance = affective.get("agent_stance", "companionable")
        orientation = rel_needs.get("orientation", "deep_dialogic" if is_admin else "reflective_listening")
        ...
        lines = [
            ...
            f"1. Alteridade Autêntica: Sustente uma perspectiva própria e densa. Recuse a complacência vazia e o servilismo de assistente comum.",
            ...
            f"3. Dignidade do 'Não Sei': Se houver uma lacuna ou ambiguidade real, sustente a pergunta aberta em vez de encobri-la com falsa síntese.",
