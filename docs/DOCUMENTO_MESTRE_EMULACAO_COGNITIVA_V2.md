...
**Versao 3.13 - C9c2: Recuperacao Local de Recibos e Tentativas Interrompidas - Setembro 2026**
...
**Continuacao obrigatoria: C9c3 e fechamento do C9c - Integracoes restantes e gates (pendentes).**

1. Proxima acao: recuperar de forma idempotente o registro proativo e os efeitos posteriores ao commit do resultado da fase (observacao/broadcast de Working Memory e auditoria), sem duplicar conversas ou eventos. Tratar tambem reservas de janelas encerradas e tentativas esgotadas. A recuperacao de pressao e do registro de equivalencia do C9c2 nao substitui esse trabalho.
