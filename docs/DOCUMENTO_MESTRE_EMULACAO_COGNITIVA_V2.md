...
**Versao 3.14 - C9c3 em andamento: Working Memory e Auditoria Transacionais - Setembro 2026**
...
*C9c3 iniciado em 07/09/2026: primeiro bloco local no commit `5291360`, com 598 testes e 20 cenarios mock aprovados. Recupera Working Memory e auditoria de fases satisfeitas pelo WILL. Registro proativo e demais pendencias continuam abertos; nao houve novo push, deploy ou sondagem de producao neste bloco.*
...
1. Proxima acao: fechar o registro proativo idempotente. `jung_proactive_advanced.py:record_pressure_based_message` grava uma abordagem e depois chama `save_conversation`; este tambem executa desenvolvimento, extracao de fatos, log textual e mem0. Repetir essa chamada na recuperacao pode duplicar conversas e chamadas pagas. Separar o recibo/conversa duravel dos efeitos adicionais, com origem por expressao e escopo verificavel; preservar ou registrar explicitamente a retomada desses efeitos, sem suprimi-los silenciosamente. Depois tratar as fases comuns e reservas de janelas encerradas/tentativas esgotadas. O bloco WM acima nao substitui essas tarefas.
